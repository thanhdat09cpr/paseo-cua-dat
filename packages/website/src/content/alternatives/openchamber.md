...
description: Paseo is an OpenChamber alternative for developers who want multiple agent harnesses, application plugins, and an AGPL-3.0 codebase.
nav: OpenChamber
order: 52
---
...
Paseo orchestrates many coding-agent harnesses from desktop, mobile, web, and the CLI. Open source under AGPL-3.0.
