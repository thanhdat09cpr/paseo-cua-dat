...
Distribution: native apps for Mac, Windows, Linux, iOS, and Android; web app; Homebrew; npm. Source: AGPL-3.0-or-later at https://github.com/webplode/paseo-doctrine-downstream. Upstream: Apache-2.0 at https://github.com/getpaseo/paseo. Marketing site: https://paseo.sh.
`;
