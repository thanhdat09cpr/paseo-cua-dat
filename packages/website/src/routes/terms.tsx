  ...
  return (
    <LegalPage title="Terms of Service" lastUpdated="August 29, 2026">
      ...
      <section>
        ...
        <p>
          Paseo is open-source software licensed under the GNU Affero General Public License v3.0 or
          later. You can install, modify, and self-host it under that license without purchasing
          Paseo Hub or using the official relay.
        </p>
        <p>
