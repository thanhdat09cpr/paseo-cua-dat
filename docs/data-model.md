...
| `runtimeConfigOverride` | `RuntimeConfigOverride?`                 | Human-selected live model override; does not rewrite a role-bound launch contract                                                                                                                                                                                                                                                                                                   |
...
### Nested: RuntimeConfigOverride

| Field   | Type      | Description                                                                                  |
| ------- | --------- | -------------------------------------------------------------------------------------------- |
| `model` | `string?` | Human-selected live model for a role-bound agent; absent means use the launch-contract model |
